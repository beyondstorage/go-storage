...
// ServicerType is the servicer type for s3
const ServicerType = types.ServicerType("s3")

// StoragerType is the storager type for s3
const StoragerType = types.StoragerType("s3")
