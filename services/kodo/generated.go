...
const (
	InfoObjectMetaStorageClass = "kodo-storage-class"
)
...
func GetStorageClass(m info.ObjectMeta) (int, bool) {
...
func setStorageClass(m info.ObjectMeta, v int) info.ObjectMeta {
