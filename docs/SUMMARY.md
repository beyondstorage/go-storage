...
* [1-unify-storager-behavior](./design/1-unify-storager-behavior.md)
* [2-use-callback-in-list-operations](./design/2-use-callback-in-list-operations.md)
* [3-support-service-init-via-config-string](./design/3-support-service-init-via-config-string.md)
* [4-credential-refactor](./design/4-credential-refactor.md)
* [5-add-id-in-object](./design/5-add-id-in-object.md)
* [6-normalize-metadata](./design/6-normalize-metadata.md)
* [7-support-context](./design/7-support-context.md)
* [8-normalize-metadata-storage-class](./design/8-normalize-metadata-storage-class.md)
* [9-remove-storager-init](./design/9-remove-storager-init.md)
* [10-callback-reader](./design/10-callback-reader.md)
...
* [cos](./services/cos.md)
* [dropbox](./services/dropbox.md)
* [fs](./services/fs.md)
* [gcs](./services/gcs.md)
* [kodo](./services/kodo.md)
* [oss](./services/oss.md)
* [qingstor](./services/qingstor.md)
* [s3](./services/s3.md)
* [uss](./services/uss.md)
